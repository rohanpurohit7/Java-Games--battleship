...
final class GameSounds {
    ...
    static void admiralTaunt() {
        String taunt = "So, commander, you found my fleet. Enjoy the victory while the smoke clears.";
        Thread voiceThread = new Thread(() -> speakWithWindowsVoice(taunt));
